...
type IBObjectManager interface {
	...
	CreateHTTPSRecord(name string, comment string, svcParameters []Svcparams, targetName string, disable bool, extAttrs EA, priority uint32, forbidReclamation bool, Ttl uint32, UseTtl bool, view string,creator string,ddnsPrincipal string, ddnsProtected bool) (*RecordHttps, error)
	...
	GetRecordHTTPSByRef(ref string) (*RecordHttps, error)
	...
	UpdateHttpsRecord(ref string, name string, comment string, svcParameters []Svcparams, targetName string, disable bool, extAttrs EA, priority uint32, forbidReclamation bool, Ttl uint32, UseTtl bool,creator string,ddnsPrincipal string, ddnsProtected bool) (*RecordHttps, error)
