...
type IBObjectManager interface {
	...
	CreateMXRecord(dnsView string, fqdn string, mx string, priority int, ttl uint32, useTtl bool, comment string, eas EA) (*RecordMX, error)
	...
	GetMXRecord(dnsView string, fqdn string) (*RecordMX, error)
	...
	UpdateMXRecord(ref string, dnsView string, fqdn string, mx string, ttl uint32, useTtl bool, comment string, priority int, eas EA) (*RecordMX, error)
