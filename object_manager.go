...
type IBObjectManager interface {
	...
	CreateSRVRecord(dnsView string, name string, priority int, weight int, port uint32, target string, ttl uint32, useTtl bool, comment string, eas EA) (*RecordSRV, error)
	...
	UpdateSRVRecord(ref string, name string, priority int, weight int, port uint32, target string, ttl uint32, useTtl bool, comment string, eas EA) (*RecordSRV, error)
