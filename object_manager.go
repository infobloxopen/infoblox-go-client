...
type IBObjectManager interface {
	...
	CreateSRVRecord(dnsView string, fqdn string, priority int, weight int, port int, target string, ttl uint32, useTtl bool, comment string, eas EA) (*RecordSRV, error)
	...
	GetSRVRecord(dnsView string, fqdn string) (*RecordSRV, error)
	...
	UpdateSRVRecord(ref string, dnsView string, fqdn string, priority int, weight int, port int, target string, ttl uint32, useTtl bool, comment string, eas EA) (*RecordSRV, error)
