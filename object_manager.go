...
type IBObjectManager interface {
	...
	CreateAliasRecord(name string, view string, targetName string, targetType string, comment string, disable bool, ea EA, ttl uint32, useTtl bool) (*RecordAlias, error)
	...
	UpdateAliasRecord(ref string, name string, view string, targetName string, targetType string, comment string, disable bool, ea EA, ttl uint32, useTtl bool) (*RecordAlias, error)
