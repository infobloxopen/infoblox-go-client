...
type Approvalworkflow struct {
	IBBase                  `json:"-"`
	Ref                     string `json:"_ref,omitempty"`
	ApprovalGroup           string `json:"approval_group"`
	...
	SubmitterGroup          string `json:"submitter_group"`
...
type Bulkhostnametemplate struct {
	IBBase         `json:"-"`
	Ref            string `json:"_ref,omitempty"`
	IsGridDefault  bool   `json:"is_grid_default"`
...
type Csvimporttask struct {
	...
	LinesFailed    uint32    `json:"lines_failed"`
	LinesProcessed uint32    `json:"lines_processed"`
	LinesWarning   uint32    `json:"lines_warning"`
...
type DbObjects struct {
	IBBase          `json:"-"`
	Ref             string `json:"_ref,omitempty"`
	LastSequenceId  string `json:"last_sequence_id"`
	Object          string `json:"object"`
	ObjectTypeField string `json:"object_type"`
...
type DhcpStatistics struct {
	IBBase                `json:"-"`
	Ref                   string `json:"_ref,omitempty"`
	DhcpUtilization       uint32 `json:"dhcp_utilization"`
	DhcpUtilizationStatus string `json:"dhcp_utilization_status"`
	DynamicHosts          uint32 `json:"dynamic_hosts"`
	StaticHosts           uint32 `json:"static_hosts"`
...
type DiscoveryDevicesupportbundle struct {
	...
	IntegratedInd bool   `json:"integrated_ind"`
	Name          string `json:"name"`
	Version       string `json:"version"`
	Ea            EA     `json:"extattrs"`
}
...
type DiscoverySdnnetwork struct {
	...
	Name            string    `json:"name"`
	NetworkView     string    `json:"network_view"`
	SourceSdnConfig string    `json:"source_sdn_config"`
	Ea              EA        `json:"extattrs"`
}
...
type Discoverytask struct {
	...
	DiscoveryTaskOid        string                         `json:"discovery_task_oid"`
...
type DiscoveryMemberproperties struct {
	...
	DiscoveryMember        string                      `json:"discovery_member"`
...
type DtcAllrecords struct {
	...
	Comment   string `json:"comment"`
	Disable   bool   `json:"disable,omitempty"`
	DtcServer string `json:"dtc_server"`
	Record    string `json:"record,omitempty"`
	Ttl       uint32 `json:"ttl,omitempty"`
	Type      string `json:"type"`
	Ea        EA     `json:"extattrs"`
...
type DxlEndpoint struct {
	...
	Name                       string                            `json:"name"`
	OutboundMemberType         string                            `json:"outbound_member_type"`
...
type GridCloudapiCloudstatistics struct {
	IBBase                  `json:"-"`
	Ref                     string `json:"_ref,omitempty"`
	AllocatedAvailableRatio uint32 `json:"allocated_available_ratio"`
	AllocatedIpCount        uint32 `json:"allocated_ip_count"`
	AvailableIpCount        string `json:"available_ip_count"`
	FixedIpCount            uint32 `json:"fixed_ip_count"`
	FloatingIpCount         uint32 `json:"floating_ip_count"`
	TenantCount             uint32 `json:"tenant_count"`
	TenantIpCount           uint32 `json:"tenant_ip_count"`
	TenantVmCount           uint32 `json:"tenant_vm_count"`
	Ea                      EA     `json:"extattrs"`
}
...
type GridCloudapi struct {
	IBBase           `json:"-"`
	Ref              string                     `json:"_ref,omitempty"`
	AllowApiAdmins   string                     `json:"allow_api_admins"`
	AllowedApiAdmins []*GridCloudapiUser        `json:"allowed_api_admins"`
...
type GridDashboard struct {
	IBBase                                   `json:"-"`
	Ref                                      string `json:"_ref,omitempty"`
	AnalyticsTunnelingEventCriticalThreshold uint32 `json:"analytics_tunneling_event_critical_threshold"`
	AnalyticsTunnelingEventWarningThreshold  uint32 `json:"analytics_tunneling_event_warning_threshold"`
	AtpCriticalEventCriticalThreshold        uint32 `json:"atp_critical_event_critical_threshold"`
	AtpCriticalEventWarningThreshold         uint32 `json:"atp_critical_event_warning_threshold"`
	AtpMajorEventCriticalThreshold           uint32 `json:"atp_major_event_critical_threshold"`
	AtpMajorEventWarningThreshold            uint32 `json:"atp_major_event_warning_threshold"`
	AtpWarningEventCriticalThreshold         uint32 `json:"atp_warning_event_critical_threshold"`
	AtpWarningEventWarningThreshold          uint32 `json:"atp_warning_event_warning_threshold"`
	RpzBlockedHitCriticalThreshold           uint32 `json:"rpz_blocked_hit_critical_threshold"`
	RpzBlockedHitWarningThreshold            uint32 `json:"rpz_blocked_hit_warning_threshold"`
	RpzPassthruEventCriticalThreshold        uint32 `json:"rpz_passthru_event_critical_threshold"`
	RpzPassthruEventWarningThreshold         uint32 `json:"rpz_passthru_event_warning_threshold"`
	RpzSubstitutedHitCriticalThreshold       uint32 `json:"rpz_substituted_hit_critical_threshold"`
	RpzSubstitutedHitWarningThreshold        uint32 `json:"rpz_substituted_hit_warning_threshold"`
	Ea                                       EA     `json:"extattrs"`
}
...
type GridFiledistribution struct {
	...
	Name               string `json:"name"`
	StorageLimit       uint32 `json:"storage_limit"`
	Ea                 EA     `json:"extattrs"`
}
...
type GridMaxminddbinfo struct {
	IBBase             `json:"-"`
	Ref                string    `json:"_ref,omitempty"`
	BinaryMajorVersion uint32    `json:"binary_major_version"`
	BinaryMinorVersion uint32    `json:"binary_minor_version"`
...
type GridDhcpproperties struct {
	...
	DenyBootp                            bool                     `json:"deny_bootp,omitempty"`
	DisableAllNacFilters                 bool                     `json:"disable_all_nac_filters"`
...
type GridServicerestartStatus struct {
	...
	NeededRestart  uint32 `json:"needed_restart"`
	NoRestart      uint32 `json:"no_restart"`
	Parent         string `json:"parent"`
	Pending        uint32 `json:"pending"`
	PendingRestart uint32 `json:"pending_restart"`
	Processing     uint32 `json:"processing"`
	Restarting     uint32 `json:"restarting"`
...
type GridThreatanalytics struct {
	...
	EnableAutoDownload                      bool                                    `json:"enable_auto_download"`
	EnableScheduledDownload                 bool                                    `json:"enable_scheduled_download"`
	...
	ModuleUpdatePolicy                      string                                  `json:"module_update_policy"`
...
type Hostnamerewritepolicy struct {
	...
	Name                 string `json:"name"`
	PreDefined           bool   `json:"pre_defined,omitempty"`
	ReplacementCharacter string `json:"replacement_character"`
	ValidCharacters      string `json:"valid_characters"`
	Ea                   EA     `json:"extattrs"`
}
...
type HsmAllgroups struct {
	IBBase `json:"-"`
	Ref    string             `json:"_ref,omitempty"`
	Groups []*HsmSafenetgroup `json:"groups"`
	Ea     EA                 `json:"extattrs"`
}
...
type Ipv4address struct {
	...
	DhcpClientIdentifier string              `json:"dhcp_client_identifier"`
	DiscoverNowStatus    string              `json:"discover_now_status,omitempty"`
	DiscoveredData       *Discoverydata      `json:"discovered_data,omitempty"`
	Fingerprint          string              `json:"fingerprint,omitempty"`
	IpAddress            string              `json:"ip_address"`
...
type Ipv6rangetemplate struct {
	...
	Name                  string                    `json:"name"`
	NumberOfAddresses     uint32                    `json:"number_of_addresses"`
...
// License represents Infoblox object license:gridwide
type License struct {
	IBBase           `json:"-"`
	Ref              string    `json:"_ref,omitempty"`
	ExpirationStatus string    `json:"expiration_status,omitempty"`
...
func (License) ObjectType() string {
...
type Macfilteraddress struct {
	...
	Fingerprint         string    `json:"fingerprint,omitempty"`
	GuestCustomField1   string    `json:"guest_custom_field1"`
	GuestCustomField2   string    `json:"guest_custom_field2"`
	GuestCustomField3   string    `json:"guest_custom_field3"`
	GuestCustomField4   string    `json:"guest_custom_field4"`
	...
	IsRegisteredUser    bool      `json:"is_registered_user"`
	Mac                 string    `json:"mac"`
	NeverExpires        bool      `json:"never_expires"`
	ReservedForInfoblox string    `json:"reserved_for_infoblox"`
	Username            string    `json:"username"`
	Ea                  EA        `json:"extattrs"`
}
...
type Member struct {
	...
	Comment                         string                          `json:"comment,omitempty"`
	ConfigAddrType                  string                          `json:"config_addr_type"`
...
type NsgroupDelegation struct {
	...
	Ref        string       `json:"_ref,omitempty"`
	Comment    string       `json:"comment,omitempty"`
	DelegateTo []NameServer `json:"delegate_to"`
	Name       string       `json:"name"`
	Ea         EA           `json:"extattrs"`
}
...
type NsgroupForwardstubserver struct {
	...
	Ref             string       `json:"_ref,omitempty"`
	Comment         string       `json:"comment,omitempty"`
	ExternalServers []NameServer `json:"external_servers"`
	Name            string       `json:"name"`
	Ea              EA           `json:"extattrs"`
}
...
type ParentalcontrolSubscriber struct {
	IBBase                       `json:"-"`
	Ref                          string   `json:"_ref,omitempty"`
	AltSubscriberId              string   `json:"alt_subscriber_id"`
...
type ParentalcontrolSubscribersite struct {
	...
	StrictNat          bool                         `json:"strict_nat"`
	Ea                 EA                           `json:"extattrs"`
}
...
type ParentalcontrolSubscriberrecord struct {
	IBBase                 `json:"-"`
	Ref                    string `json:"_ref,omitempty"`
	AccountingSessionId    string `json:"accounting_session_id"`
...
type Scavengingtask struct {
	...
	Ref                string    `json:"_ref,omitempty"`
	Action             string    `json:"action"`
	AssociatedObject   string    `json:"associated_object"`
...
type SharedrecordA struct {
	...
	Ipv4Addr          string `json:"ipv4addr"`
	Name              string `json:"name"`
	SharedRecordGroup string `json:"shared_record_group"`
	Ttl               uint32 `json:"ttl,omitempty"`
	UseTtl            bool   `json:"use_ttl,omitempty"`
	Ea                EA     `json:"extattrs"`
}
...
type SmartfolderChildren struct {
	...
	Value     *SmartfolderQueryitemvalue `json:"value"`
	ValueType string                     `json:"value_type"`
	Ea        EA                         `json:"extattrs"`
}
...
type Superhostchild struct {
	...
	NetworkView       string    `json:"network_view"`
	Parent            string    `json:"parent"`
	RecordParent      string    `json:"record_parent"`
	Type              string    `json:"type"`
	View              string    `json:"view"`
	Ea                EA        `json:"extattrs"`
}
...
type ThreatprotectionStatistics struct {
	...
	Ref       string                      `json:"_ref,omitempty"`
	Member    string                      `json:"member"`
	StatInfos []*ThreatprotectionStatinfo `json:"stat_infos"`
	Ea        EA                          `json:"extattrs"`
}
...
type UpgradeStatus struct {
	...
	StatusValueUpdateTime       time.Time        `json:"status_value_update_time"`
...
type Vlanrange struct {
	...
	EndVlanId           uint32               `json:"end_vlan_id"`
	Name                string               `json:"name"`
	...
	StartVlanId         uint32               `json:"start_vlan_id"`
	VlanNamePrefix      string               `json:"vlan_name_prefix,omitempty"`
	VlanView            string               `json:"vlan_view"`
	Ea                  EA                   `json:"extattrs"`
}
...
type ZoneStub struct {
	...
	StubFrom             []NameServer    `json:"stub_from"`
	StubMembers          []*Memberserver `json:"stub_members,omitempty"`
...
type ZoneForward struct {
	...
	DnsFqdn              string                    `json:"dns_fqdn,omitempty"`
	ExternalNsGroup      string                    `json:"external_ns_group,omitempty"`
	ForwardTo            []NameServer              `json:"forward_to"`
