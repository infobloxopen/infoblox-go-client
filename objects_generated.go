...
type Authpolicy struct {
	...
	AdminGroups []string `json:"admin_groups,omitempty"`
	// The array that contains an ordered list of refs to localuser:authservice
	// object, ldap_auth_service object, radius:authservice object,
	// tacacsplus:authservice object, ad_auth_service object,
	// certificate:authservice object. saml:authservice object,
...
type Allrecords struct {
	...
	// The disable value determines if the record is disabled or not. “False”
	// means the record is enabled.
	Disable bool `json:"disable,omitempty"`
	...
	// The record object, if supported by the WAPI. Otherwise, the value is
	// “None”.
	Record string `json:"record,omitempty"`
...
type Approvalworkflow struct {
	...
	// Determines whether e-mail notifications to admin group’s e-mail address
	// are enabled.
	EnableNotifyGroup bool `json:"enable_notify_group,omitempty"`
	// Determines whether e-mail notifications to an admin member’s e-mail
	// address are enabled.
...
type Admingroup struct {
	...
	Comment string `json:"comment,omitempty"`
	// Database set commands for database admin group.
...
type DbObjects struct {
	...
	// The record object when supported by WAPI. Otherwise, the value is
	// “None”.
...
type DtcLbdn struct {
	...
	// The LBDN pattern match priority for “overlapping” DTC LBDN objects.
	// LBDNs are “overlapping” if they are simultaneously assigned to a zone
	// and have patterns that can match the same FQDN. The matching LBDN with
	// highest priority (lowest ordinal) will be used.
...
type DtcMonitor struct {
	...
	// The number of many times the server should appear as “UP” to be treated
...
type DtcRecordNaptr struct {
	...
	// record object. Supported values for the flags field are “U”, “S”,
	// “P” and “A”.
	...
	// services field contains protocol and service identifiers, such as
...
type Filtermac struct {
	...
	// An array of DHCP option structs that lists the DHCP options associated with
	// the object.
...
type Fixedaddresstemplate struct {
	...
	// and/or IP address of the boot server that the host needs to boot.
	Bootserver string `json:"bootserver,omitempty"`
...
type GridDhcpproperties struct {
	...
	// Determines if the Grid DHCP server’s ability to update the A and PTR
	...
	// addresses. Valid values are “NONE”, “CLIENT”, or “MACADDR”. The
	// default is “NONE”.
	...
	// An array of DHCP option structs that lists the DHCPv6 options associated
	// with the object.
	...
	// “RELEASE_MACHING_ID”, “NEVER_RELEASE”, or
	// “ONE_LEASE_PER_CLIENT”. The default is “RELEASE_MATCHING_ID”.
	...
	// database beyond a specified period of time.
	...
	// addresses exceeds this value, a corresponding SNMP trap is reset.
	...
	// An array of DHCP option structs that lists the DHCP options associated with
	// the object. Note that WAPI does not return special options ‘routers’,
	// ‘domain-name-servers’, ‘domain-name’ and ‘broadcast-address’
	// with empty values for this object.
	Options []*Dhcpoption `json:"options,omitempty"`
	...
	// such as a TFTP server, and download the file it needs to boot.
	PxeLeaseTime uint32 `json:"pxe_lease_time,omitempty"`
...
type GridCloudapiVmaddress struct {
	...
	// Array of string denoting the types of underlying objects IPv4/IPv6 -
	// “A”, “AAAA”, “PTR”, “HOST”, “FA”, “RESERVATION”,
	// “UNMANAGED” + (“BULKHOST”, “DHCP_RANGE”, “RESERVED_RANGE”,
	// “LEASE”, “NETWORK”, “BROADCAST”, “PENDING”),
...
type GridMaxminddbinfo struct {
	...
	// The structure of data records (“GeoLite2-Country”, GeoLite2-City”,
	// etc.).
...
type Grid struct {
	...
	// If ‘audit_to_syslog_enable’ is set to True, the facility that determines
	// the processes and daemons from which the log messages are generated.
	SyslogFacility string `json:"syslog_facility,omitempty"`
...
type GridDns struct {
	...
	// -$1-$2-$3-$4 “Three Octets” -$2-$3-$4 “Two Octets” -$3-$4 “One
	// Octet” -$4
	...
	// it to be cached by the DNS Cache Acceleration service.
	...
	// DTC topology, users may configure classification as either “Geographic”
	// or “Extensible Attributes”. Selecting extensible attributes will replace
	...
	// field to ‘true’, unless the same request sets the enable field to
	// ‘false’.
	...
	// number in the zone transfer request.
	...
	// queries ensures that a firewall will allow the response.
...
type Ipv6Network struct {
	...
	// A list of members servers that serve DHCP for the network.
	...
	// portion is always an exact match.
	Network string `json:"network,omitempty"`
...
type Ipv6range struct {
	IBBase `json:"-"`
	Ref    string `json:"_ref,omitempty"`
	// Type of a DHCP IPv6 Range object. Valid values are “ADDRESS”,
	// “PREFIX”, or “BOTH”. When the address type is “ADDRESS”, values
	// for the ‘start_addr’ and ‘end_addr’ members are required. When the
	// address type is “PREFIX”, values for ‘ipv6_start_prefix’,
	// ‘ipv6_end_prefix’, and ‘ipv6_prefix_bits’ are required. When the
	// address type is “BOTH”, values for ‘start_addr’, ‘end_addr’,
	// ‘ipv6_start_prefix’, ‘ipv6_end_prefix’, and ‘ipv6_prefix_bits’
	// are all required.
	AddressType string `json:"address_type,omitempty"`
	// Structure containing all cloud API related information for this object.
	CloudInfo *GridCloudapiInfo `json:"cloud_info,omitempty"`
...
type Ipv6FixedAddress struct {
	IBBase `json:"-"`
	Ref    string `json:"_ref,omitempty"`
	// The address type value for this IPv6 fixed address.
	AddressType string `json:"address_type,omitempty"`
	// This field controls whether the credential is used for both the Telnet and
	// SSH credentials. If set to False, the credential is used only for SSH.
	AllowTelnet bool `json:"allow_telnet,omitempty"`
...
type MemberDhcpproperties struct {
	...
	// authenticated updates from DHCP clients.
	EnableGssTsig bool `json:"enable_gss_tsig,omitempty"`
	// Determines if the Grid member’s host name rewrite feature is enabled or
	// not.
	EnableHostnameRewrite bool `json:"enable_hostname_rewrite,omitempty"`
...
type MemberDns struct {
	...
	// member. Only one of “additional_ip_list” or
	// “additional_ip_list_struct” should be set when modifying the object.
	...
	// on which DNS is enabled for a Grid member. Only one of
	// “additional_ip_list” or “additional_ip_list_struct” should be set
	...
	// The number of seconds to cache lame delegations or lame servers.
	LameTtl uint32 `json:"lame_ttl,omitempty"`
	// The IP space discriminator for LAN1 interface.
	Lan1Ipsd string `json:"lan1_ipsd,omitempty"`
	// The IP space discriminator for IPv6 LAN1 interface.
	Lan1Ipv6Ipsd string `json:"lan1_ipv6_ipsd,omitempty"`
	// The IP space discriminator for LAN2 interface.
	Lan2Ipsd string `json:"lan2_ipsd,omitempty"`
	// The IP space discriminator for IPv6 LAN2 interface.
	...
	// bytes. The recommended value is between 512 and 1220 bytes.
	MaxUdpSize uint32 `json:"max_udp_size,omitempty"`
	// The IP space discriminator for MGMT interface.
	MgmtIpsd string `json:"mgmt_ipsd,omitempty"`
	// The IP space discriminator for IPv6 MGMT interface.
...
type Member struct {
	...
	// interface information that can be used at the member level.
	...
	// If this is set to “true”, the LAN2 port is enabled as an independent
	// port or as a port for failover purposes.
	Lan2Enabled bool `json:"lan2_enabled,omitempty"`
	// Settings for the Grid member LAN2 port if ‘lan2_enabled’ is set to
	// “true”.
	...
	// specify a value, the default value is “false”. You can only set this
	// value to “true” if the member is an HA pair.
	...
	// Virutal router identifier. Provide this ID if “ha_enabled” is set to
	// “true”. This is a unique VRID number (from 1 to 255) for the local
	// subnet.
...
type NetworkView struct {
	...
	// An array of Ddns Zone Primary structs that lists the information of primary
	// zone to wich DDNS updates should be sent.
	DdnsZonePrimaries []*Dhcpddns `json:"ddns_zone_primaries,omitempty"`
	// Extensible attributes associated with the object.
	Ea EA `json:"extattrs,omitempty"`
...
type Networktemplate struct {
	...
	// address of the boot server that the host needs to boot.
	Bootserver string `json:"bootserver,omitempty"`
	// This flag controls whether this template can be used to create network
	// objects in a cloud-computing deployment.
	CloudApiCompatible bool `json:"cloud_api_compatible,omitempty"`
	...
	// generates a syslog message and sends a warning (if enabled).
	LowWaterMark uint32 `json:"low_water_mark,omitempty"`
...
type Nsgroup struct {
	...
	IsGridDefault bool `json:"is_grid_default,omitempty"`
	// Determines if the “multiple DNS primaries” feature is enabled for the
	// group.
	...
	// modification of this field requires passing values for
	// “grid_secondaries” and “external_primaries”.
...
// This object represents a set of parental control properties for IP space
// discriminator.
type ParentalcontrolIpspacediscriminator struct {
	IBBase `json:"-"`
	Ref    string `json:"_ref,omitempty"`
	// The name of the IP space discriminator.
	Name string `json:"name,omitempty"`
	// The value of the IP space discriminator.
	Value string `json:"value,omitempty"`
}
...
type ParentalcontrolSubscriber struct {
	...
	// Category content authorization string per customer for remote RD lookup and
	// category access.
	...
	// match url regex pattern “^http|https://”. The new default value does not
	// get saved in database, but rather used for comparision with object created
	// in unit test cases.
...
type Permission struct {
	...
	// ‘resource_type’ was set to ‘A’, the permission would apply to A
	// Resource Records within the specified zone.
...
type Rangetemplate struct {
	...
	// client has requested.
	IgnoreDhcpOptionListRequest bool `json:"ignore_dhcp_option_list_request,omitempty"`
	// Permission for known clients. If set to ‘Deny’ known clients will be
	// denied IP addresses.
...
type Range struct {
	...
	// A list of MAC addresses the appliance will ignore.
	IgnoreMacAddresses []string `json:"ignore_mac_addresses,omitempty"`
	// This field will be ‘true’ if this particular range is part of a split
	// scope.
	IsSplitScope bool `json:"is_split_scope,omitempty"`
	// Permission for known clients. This can be ‘Allow’ or ‘Deny’. If set
	// to ‘Deny’ known clients will be denied IP addresses.
	KnownClients string `json:"known_clients,omitempty"`
	// An integer that specifies the period of time (in seconds) that frees and
	// backs up leases remained in the database before they are automatically
	// deleted. To disable lease scavenging, set the parameter to -1. The minimum
	...
	// split_scope_exclusion_percent for more information
	...
	TotalHosts uint32 `json:"total_hosts,omitempty"`
	// Permission for unknown clients. This can be ‘Allow’ or ‘Deny’. If
	// set to ‘Deny’, unknown clients will be denied IP addresses.
	UnknownClients string `json:"unknown_clients,omitempty"`
	// This field controls whether the DHCP server updates DNS when a DHCP lease is
	// renewed.
	UpdateDnsOnLeaseRenewal bool `json:"update_dns_on_lease_renewal,omitempty"`
...
type RecordA struct {
	...
	// Use flag for: ttl
	UseTtl bool `json:"use_ttl,omitempty"`
	// The name of the DNS view in which the record resides. Example:
	// “external”.
	View string `json:"view,omitempty"`
	// The name of the zone in which the record resides. Example: “zone.com”.
...
type RecordCaa struct {
	...
	// The creation time of the record.
	CreationTime *UnixTime `json:"creation_time,omitempty"`
	// The record creator. Note that changing creator from or to ‘SYSTEM’ value
	// is not allowed.
	Creator string `json:"creator,omitempty"`
	// The GSS-TSIG principal that owns this record.
	DdnsPrincipal string `json:"ddns_principal,omitempty"`
...
type RecordDname struct {
	...
	// “external”.
	View string `json:"view,omitempty"`
	// The name of the zone in which the record resides. For example:
	// “zone.com”. If a view is not specified when searching by zone, the
...
type HostRecordIpv6Addr struct {
	...
	// The time of the last DNS query in Epoch seconds format.
	LastQueried *UnixTime `json:"last_queried,omitempty"`
	// Set this to ‘DUID’ to assign the IP address to the selected host,
	// provided that the DUID of the requesting host matches the DUID that you
...
type Ipv4NetworkContainer struct {
	...
	// and sends a warning (if enabled).
	HighWaterMark uint32 `json:"high_water_mark,omitempty"`
	...
	// appliance generates a syslog message and sends a warning (if enabled).
	LowWaterMark uint32 `json:"low_water_mark,omitempty"`
	...
	// not leased longer than necessary.
	PxeLeaseTime uint32 `json:"pxe_lease_time,omitempty"`
	// If the field is set to True, the leases are kept in the Recycle Bin until
	// one week after expiration. Otherwise, the leases are permanently deleted.
	RecycleLeases bool `json:"recycle_leases,omitempty"`
...
type RecordPTR struct {
	...
	// Use flag for: ttl
	UseTtl bool `json:"use_ttl,omitempty"`
	// Name of the DNS View in which the record resides, for example
	// “external”.
	View string `json:"view,omitempty"`
	// The name of the zone in which the record resides. For example:
	// “zone.com”.
...
type RecordRpzNaptr struct {
	...
	// (NAPTR Record) Rule object. Supported values for the flags field are
	// “U”, “S”, “P” and “A”.
	Flags string `json:"flags,omitempty"`
	// The time of the last DNS query in Epoch seconds format.
	LastQueried *UnixTime `json:"last_queried,omitempty"`
...
type SharedrecordTxt struct {
	...
	// embedded spaces in the text, add quotes (” ”) around the text to
	// preserve the spaces.
	Text string `json:"text,omitempty"`
	// The Time To Live (TTL) value for this shared record. A 32-bit unsigned
	// integer that represents the duration, in seconds, for which the shared
...
type Vdiscoverytask struct {
	...
	// If set true, all keystone connection will use “/identity” endpoint and
	// port value will be ignored.
...
type UpgradeStatus struct {
	...
	// The type of subelements to be requested. If ‘type’ is ‘GROUP’, or
	// ‘VNODE’, then ‘upgrade_group’ or ‘member’ should have proper
	// values for an operation to return data specific for the values passed.
	// Otherwise, overall data is returned for every group or physical node.
	...
	// Upload version summary for the ‘type’ requested. This field can be
	// requested for the Grid, a certain group that has virtual nodes as
	// subelements, or overall group status.
...
type View struct {
	...
	// Specify “true” to enable logging, or “false” to disable it. The
	...
	// Determines if the fixed RRset order FQDN is enabled or not.
	EnableFixedRrsetOrderFqdns bool `json:"enable_fixed_rrset_order_fqdns,omitempty"`
	// Determines if the ‘match-recursive-only’ option in a DNS view is enabled
	// or not.
...
type ZoneDelegated struct {
	...
	// “address/cidr” format. For other zones, this is in FQDN format in
	// punycode format.
	...
	// “allow_ptr_creation_in_parent” set to False. However, when this flag is
	// set to True the existing PTR records are not overwritten.
	...
	// server as primary allows dynamic updates. Valid values are:
	...
	// Microsoft DNS server. Valid values are:
	...
	// zone in read-only mode, false otherwise.
...
type ZoneRp struct {
	...
	// value at “soa_serial_number” and pass “set_soa_serial_number” as
	// True.
...
type ZoneAuth struct {
	...
	// from DHCP clients and servers in an AD domain.
	...
	// Setting this address to ‘255.255.255.255’ and do_host_abstraction to
	// ‘true’ will create Host records from A records in this zone without
	// importing zone data.
	...
	// applies only if the host name restriction policy is set to “Strict
	// Hostname Checking”.)
