...
func (c *fakeConnector) CreateObject(obj IBObject) (string, error) {
	c.createObjectObj = obj
	return c.fakeRefReturn, nil
}

func TestNewRecordA(t *testing.T) {
	type args struct {
		ra RecordA
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewRecordA(tt.args.ra); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewRecordA() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func (c *fakeConnector) DeleteObject(ref string) (string, error) {
	c.deleteObjectRef = ref

	return c.fakeRefReturn, nil
}

func (c *fakeConnector) UpdateObject(obj IBObject, ref string) (string, error) {
	c.updateObjectObj = obj
	c.updateObjectRef = ref

	return c.fakeRefReturn, nil
}
func TestObjectManager_CreateARecord(t *testing.T) {
	type Fields struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("ObjectManager.CreateARecord() error = %v, wantErr %v, got=%v,want=%v", err, tt.wantErr,got, tt.want)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ObjectManager.CreateARecord() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestObjectManager_GetARecord(t *testing.T) {
	type fields struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got:= *got1
			if (err != nil) != tt.wantErr {
				t.Errorf("ObjectManager.GetARecord() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ObjectManager.GetARecord() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestObjectManager_DeleteARecord(t *testing.T) {
	type fields struct {
		connector IBConnector
		cmpType   string
		tenantID  string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("ObjectManager.DeleteARecord() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("ObjectManager.DeleteARecord() = %v, want %v", got, tt.want)
			}
		})
	}
}
