...
var _ = Describe("Object Manager", func() {
	...
	Describe("Get IPAddressInfo", func() {
		...
		It("should pass expected get IPAddressInfo", func() {
			actualObj, err = objMgr.GetIPAddressInfo("10.38.197.235")
